      ...
      <View style={postCardStyles.postHeader}>
        ...
        <View style={postCardStyles.postInfo}>
          <View style={postCardStyles.postNameRow}>
            ...
            {degree && <Text style={postCardStyles.postDegree}>· {degree}</Text>}
          </View>
          ...
          <View style={postCardStyles.postMeta}>
            ...
            <Ionicons name="earth" size={12} color="#666" style={{marginLeft: 2}} />
          </View>
        </View>
...
const MOCK_POSTS = [
  {
    ...
    name: 'Nguyễn Văn A',
    degree: '1st',
    title: 'Senior React Native Developer | Tech Lead',
    timeAgo: '2h',
    isEdited: false,
    content:
      'Vừa hoàn thành một đợt refactor lớn cho ứng dụng chính. Chuyển từ Context API sang Zustand để quản lý state thực sự là một thay đổi lớn về hiệu suất!',
    showTranslation: false,
    image: null,
    hasHD: false,
    isFollowing: true, // Đây là bài viết của chính mình nên không "Follow"
  },
  {
    id: 2,
    avatar: 'https://picsum.photos/seed/profile/200',
    ...
    isEdited: true,
    content:
      'Rất vui được chia sẻ khoảnh khắc này từ buổi họp sprint planning tuần trước. Rất nhiều ý tưởng tuyệt vời! #reactnative #sprintplanning #agile',
    showTranslation: false,
    image: 'https://picsum.photos/seed/post_image_1/400/250',
    hasHD: true,
    isFollowing: true,
  },
];
...
//================================================================
// 3. COMPONENT PROFILESCREEN (Chính)
//================================================================
      ...
      <View style={styles.card}>
        ...
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoTextContainer}>
            ...
            <Text style={styles.infoDate}>Jan 2023 - Present • 2 yrs 10 mos</Text>
          </View>
        </View>
